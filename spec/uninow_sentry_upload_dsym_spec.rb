  ...
  describe Fastlane::FastFile do
    describe "upload dsym" do
      ...
      it "should add bcsymbols to sentry-cli call" do
        ...
        expect(Fastlane::Helper::UninowSentryHelper).to receive(:call_sentry_cli).with(["sentry-cli", "upload-dsym", "--symbol-maps", "1.bcsymbol", dsym_path_1]).and_return(true)
      ...
      it "multiple dsym paths" do
        ...
        expect(Fastlane::Helper::UninowSentryHelper).to receive(:call_sentry_cli).with(["sentry-cli", "upload-dsym", dsym_path_1, dsym_path_1]).and_return(true)
      ...
      it "Info.plist should exist" do
        ...
        expect(Fastlane::Helper::UninowSentryHelper).to receive(:call_sentry_cli).with(["sentry-cli", "upload-dsym", "--info-plist", "Info.plist", dsym_path_1]).and_return(true)
